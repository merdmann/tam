...
package body Util.Exception_Helper is

   Version : constant String :=
      "$Id: util-exception_helper.adb,v 1.1 2005/09/25 19:20:11 merdmann Exp $";
